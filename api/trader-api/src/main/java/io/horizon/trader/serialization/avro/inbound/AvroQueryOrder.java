...
public class AvroQueryOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8767404843977538927L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroQueryOrder\",\"namespace\":\"io.horizon.trader.serialization.avro.inbound\",\"doc\":\"查询订单\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvroQueryOrder> ENCODER =
      new BinaryMessageEncoder<AvroQueryOrder>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvroQueryOrder> DECODER =
      new BinaryMessageDecoder<AvroQueryOrder>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AvroQueryOrder> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroQueryOrder> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroQueryOrder> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvroQueryOrder>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AvroQueryOrder to a ByteBuffer.
  ...
  /**
   * Deserializes a AvroQueryOrder from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AvroQueryOrder instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AvroQueryOrder fromByteBuffer(
   ...
   */
  public AvroQueryOrder setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setOrdSysId(long value) {
    this.ordSysId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryOrder setOperatorId(java.lang.String value) {
    this.operatorId = value;
    return this;
  }

  /**
   * Creates a new AvroQueryOrder RecordBuilder.
   * @return A new AvroQueryOrder RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder newBuilder() {
    return new io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder();
  }

  /**
   * Creates a new AvroQueryOrder RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroQueryOrder RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder newBuilder(io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder other) {
    if (other == null) {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder();
    } else {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder(other);
    }
  }

  /**
   * Creates a new AvroQueryOrder RecordBuilder by copying an existing AvroQueryOrder instance.
   * @param other The existing instance to copy.
   * @return A new AvroQueryOrder RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder newBuilder(io.horizon.trader.serialization.avro.inbound.AvroQueryOrder other) {
    if (other == null) {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder();
    } else {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder(other);
  ...
  /**
   * RecordBuilder for AvroQueryOrder instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroQueryOrder>
    implements org.apache.avro.data.RecordBuilder<AvroQueryOrder> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroQueryOrder instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.serialization.avro.inbound.AvroQueryOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryOrder.Builder clearOperatorId() {
      operatorId = null;
    ...
    @Override
    public AvroQueryOrder build() {
      try {
        AvroQueryOrder record = new AvroQueryOrder();
  ...
  private static final org.apache.avro.io.DatumWriter<AvroQueryOrder>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvroQueryOrder>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvroQueryOrder>
    READER$ = (org.apache.avro.io.DatumReader<AvroQueryOrder>)MODEL$.createDatumReader(SCHEMA$);
