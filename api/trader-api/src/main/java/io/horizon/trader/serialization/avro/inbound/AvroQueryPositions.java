...
public class AvroQueryPositions extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6884308960426709613L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroQueryPositions\",\"namespace\":\"io.horizon.trader.serialization.avro.inbound\",\"doc\":\"查询账户持仓\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvroQueryPositions> ENCODER =
      new BinaryMessageEncoder<AvroQueryPositions>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvroQueryPositions> DECODER =
      new BinaryMessageDecoder<AvroQueryPositions>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AvroQueryPositions> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroQueryPositions> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroQueryPositions> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvroQueryPositions>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AvroQueryPositions to a ByteBuffer.
  ...
  /**
   * Deserializes a AvroQueryPositions from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AvroQueryPositions instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AvroQueryPositions fromByteBuffer(
   ...
   */
  public AvroQueryPositions(java.lang.Long generateTime, java.lang.Long sendTime, java.lang.String exchangeCode, java.lang.String instrumentCode, java.lang.String brokerId, java.lang.Integer accountId, java.lang.Integer subAccountId, java.lang.Integer strategyId, java.lang.String operatorId) {
   ...
   */
  public AvroQueryPositions setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public AvroQueryPositions setOperatorId(java.lang.String value) {
    this.operatorId = value;
    return this;
  }

  /**
   * Creates a new AvroQueryPositions RecordBuilder.
   * @return A new AvroQueryPositions RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder newBuilder() {
    return new io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder();
  }

  /**
   * Creates a new AvroQueryPositions RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroQueryPositions RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder newBuilder(io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder other) {
    if (other == null) {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder();
    } else {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder(other);
    }
  }

  /**
   * Creates a new AvroQueryPositions RecordBuilder by copying an existing AvroQueryPositions instance.
   * @param other The existing instance to copy.
   * @return A new AvroQueryPositions RecordBuilder
   */
  public static io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder newBuilder(io.horizon.trader.serialization.avro.inbound.AvroQueryPositions other) {
    if (other == null) {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder();
    } else {
      return new io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder(other);
  ...
  /**
   * RecordBuilder for AvroQueryPositions instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroQueryPositions>
    implements org.apache.avro.data.RecordBuilder<AvroQueryPositions> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroQueryPositions instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.serialization.avro.inbound.AvroQueryPositions other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.serialization.avro.inbound.AvroQueryPositions.Builder clearOperatorId() {
      operatorId = null;
    ...
    @Override
    public AvroQueryPositions build() {
      try {
        AvroQueryPositions record = new AvroQueryPositions();
  ...
  private static final org.apache.avro.io.DatumWriter<AvroQueryPositions>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvroQueryPositions>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvroQueryPositions>
    READER$ = (org.apache.avro.io.DatumReader<AvroQueryPositions>)MODEL$.createDatumReader(SCHEMA$);
