...
public class OutAvDepthMarketData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 903222223208024613L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OutAvDepthMarketData\",\"namespace\":\"io.horizon.market.serializable.record\",\"doc\":\"深度行情数据结构\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"instrumentId\",\"type\":\"int\"},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastPrice\",\"type\":\"double\"},{\"name\":\"volume\",\"type\":\"int\"},{\"name\":\"turnover\",\"type\":\"long\"},{\"name\":\"bidPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"bidVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"askPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"askVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"depth\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<OutAvDepthMarketData> ENCODER =
      new BinaryMessageEncoder<OutAvDepthMarketData>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<OutAvDepthMarketData> DECODER =
      new BinaryMessageDecoder<OutAvDepthMarketData>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<OutAvDepthMarketData> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OutAvDepthMarketData> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OutAvDepthMarketData> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<OutAvDepthMarketData>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this OutAvDepthMarketData to a ByteBuffer.
  ...
  /**
   * Deserializes a OutAvDepthMarketData from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a OutAvDepthMarketData instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static OutAvDepthMarketData fromByteBuffer(
   ...
   */
  public OutAvDepthMarketData setTimestamp(long value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setInstrumentId(int value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setLastPrice(double value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setVolume(int value) {
    this.volume = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setTurnover(long value) {
    this.turnover = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setBidPrices(java.util.List<java.lang.Double> value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setBidVolumes(java.util.List<java.lang.Integer> value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setAskPrices(java.util.List<java.lang.Double> value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setAskVolumes(java.util.List<java.lang.Integer> value) {
   ...
   * @param value the value to set.
   */
  public OutAvDepthMarketData setDepth(int value) {
    this.depth = value;
    return this;
  }

  /**
   * Creates a new OutAvDepthMarketData RecordBuilder.
   * @return A new OutAvDepthMarketData RecordBuilder
   */
  public static io.horizon.market.serializable.record.OutAvDepthMarketData.Builder newBuilder() {
    return new io.horizon.market.serializable.record.OutAvDepthMarketData.Builder();
  }

  /**
   * Creates a new OutAvDepthMarketData RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new OutAvDepthMarketData RecordBuilder
   */
  public static io.horizon.market.serializable.record.OutAvDepthMarketData.Builder newBuilder(io.horizon.market.serializable.record.OutAvDepthMarketData.Builder other) {
    if (other == null) {
      return new io.horizon.market.serializable.record.OutAvDepthMarketData.Builder();
    } else {
      return new io.horizon.market.serializable.record.OutAvDepthMarketData.Builder(other);
    }
  }

  /**
   * Creates a new OutAvDepthMarketData RecordBuilder by copying an existing OutAvDepthMarketData instance.
   * @param other The existing instance to copy.
   * @return A new OutAvDepthMarketData RecordBuilder
   */
  public static io.horizon.market.serializable.record.OutAvDepthMarketData.Builder newBuilder(io.horizon.market.serializable.record.OutAvDepthMarketData other) {
    if (other == null) {
      return new io.horizon.market.serializable.record.OutAvDepthMarketData.Builder();
    } else {
      return new io.horizon.market.serializable.record.OutAvDepthMarketData.Builder(other);
  ...
  /**
   * RecordBuilder for OutAvDepthMarketData instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OutAvDepthMarketData>
    implements org.apache.avro.data.RecordBuilder<OutAvDepthMarketData> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.market.serializable.record.OutAvDepthMarketData.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing OutAvDepthMarketData instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.market.serializable.record.OutAvDepthMarketData other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.timestamp)) {
        this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setInstrumentId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearInstrumentId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setLastPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearLastPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setVolume(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearVolume() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setTurnover(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearTurnover() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setBidPrices(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearBidPrices() {
      bidPrices = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setBidVolumes(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearBidVolumes() {
      bidVolumes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setAskPrices(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearAskPrices() {
      askPrices = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setAskVolumes(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearAskVolumes() {
      askVolumes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder setDepth(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.market.serializable.record.OutAvDepthMarketData.Builder clearDepth() {
      fieldSetFlags()[10] = false;
      return this;
    }

    @Override
    public OutAvDepthMarketData build() {
      try {
        OutAvDepthMarketData record = new OutAvDepthMarketData();
  ...
  private static final org.apache.avro.io.DatumWriter<OutAvDepthMarketData>
    WRITER$ = (org.apache.avro.io.DatumWriter<OutAvDepthMarketData>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<OutAvDepthMarketData>
    READER$ = (org.apache.avro.io.DatumReader<OutAvDepthMarketData>)MODEL$.createDatumReader(SCHEMA$);
