...
public final class AccountStorage implements Serializable {
     ...
     */
    private static final MutableIntObjectMap<Account> Accounts = MutableMaps.newIntObjectMap();
     ...
     */
    private static final MutableIntObjectMap<Account> AccountsBySubAccountId = MutableMaps.newIntObjectMap();

    /**
     * 存储SubAccount信息, 一对一关系, 以subAccountId索引
     */
    private static final MutableIntObjectMap<SubAccount> SubAccounts = MutableMaps.newIntObjectMap();
