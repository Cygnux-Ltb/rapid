...
public class SubscribeMarketData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SubscribeMarketData(io.rapid.core.protocol.avro.enums.MarketDataType type, java.lang.String instrumentCode, java.lang.String recvAddr) {
    this.type = type;
   ...
   */
  public SubscribeMarketData setType(io.rapid.core.protocol.avro.enums.MarketDataType value) {
    this.type = value;
    return this;
  }
   ...
   */
  public static io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder newBuilder() {
    return new io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder();
  }
   ...
   * @return A new SubscribeMarketData RecordBuilder
   */
  public static io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder newBuilder(io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder other) {
    if (other == null) {
      return new io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder();
    } else {
      return new io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder(other);
    }
  }
   ...
   * @return A new SubscribeMarketData RecordBuilder
   */
  public static io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder newBuilder(io.rapid.core.protocol.avro.request.SubscribeMarketData other) {
    if (other == null) {
      return new io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder();
    } else {
      return new io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubscribeMarketData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.protocol.avro.request.SubscribeMarketData other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder setType(io.rapid.core.protocol.avro.enums.MarketDataType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder setRecvAddr(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.SubscribeMarketData.Builder clearRecvAddr() {
      recvAddr = null;
