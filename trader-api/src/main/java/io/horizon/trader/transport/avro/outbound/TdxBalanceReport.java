...
public class TdxBalanceReport extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    @Serial
    private static final long serialVersionUID = -2723927839374769910L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TdxBalanceReport\",\"namespace\":\"io.horizon.trader.transport.avro.outbound\",\"doc\":\"账户可用余额回报\",\"fields\":[{\"name\":\"epochMillis\",\"type\":\"long\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"investorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"available\",\"type\":\"long\"},{\"name\":\"currencyId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 3 -> available = (Long) value$;
            case 4 -> currencyId = value$ != null ? value$.toString() : null;
            default -> throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    }
     ...
     */
    public static io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder newBuilder() {
        return new io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder();
    }
     ...
     * @return A new TdxBalanceReport RecordBuilder
     */
    public static io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder newBuilder(io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder other) {
        if (other == null) {
            return new io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder();
        } else {
            return new io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder(other);
        }
    }
     ...
     * @return A new TdxBalanceReport RecordBuilder
     */
    public static io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder newBuilder(io.horizon.trader.transport.avro.outbound.TdxBalanceReport other) {
        if (other == null) {
            return new io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder();
        } else {
            return new io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TdxBalanceReport>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(io.horizon.trader.transport.avro.outbound.TdxBalanceReport other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.epochMillis)) {
                this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder setEpochMillis(long value) {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder clearEpochMillis() {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder setBrokerId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder clearBrokerId() {
            brokerId = null;
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder setInvestorId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder clearInvestorId() {
            investorId = null;
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder setAvailable(long value) {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder clearAvailable() {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder setCurrencyId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.horizon.trader.transport.avro.outbound.TdxBalanceReport.Builder clearCurrencyId() {
            currencyId = null;
        ...
        if (fieldOrder == null) {
            ...
            for (int i = 0; i < 5; i++) {
                switch (fieldOrder[i].pos()) {
                    ...
                    case 3 -> this.available = in.readLong();
                    case 4 -> this.currencyId = in.readString();
