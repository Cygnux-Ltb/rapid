package io.cygnux.gateway.ctp.param;
...
import static io.cygnux.gateway.ctp.param.FtdcParamKey.ACCOUNT_ID;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.APP_ID;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.AUTH_CODE;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.BROKER_ID;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.CURRENCY_ID;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.INVESTOR_ID;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.IP_ADDR;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.MAC_ADDR;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.MD_ADDR;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.PASSWORD;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.TRADER_ADDR;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.TRADING_DAY;
import static io.cygnux.gateway.ctp.param.FtdcParamKey.USERID;
