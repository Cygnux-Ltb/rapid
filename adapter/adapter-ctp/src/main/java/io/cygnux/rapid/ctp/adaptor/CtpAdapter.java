...
import io.cygnux.rapid.ctp.gateway.event.FtdcRspEvent;
import io.cygnux.rapid.ctp.gateway.event.FtdcRspPublisher;
import io.cygnux.rapid.ctp.gateway.event.source.EventSource;
import io.cygnux.rapid.ctp.gateway.FtdcMdGateway;
import io.cygnux.rapid.ctp.gateway.FtdcTraderGateway;
import io.cygnux.rapid.ctp.gateway.NativeLibraryLoader;
import io.cygnux.rapid.ctp.adaptor.param.FtdcParams;
...
public class CtpAdapter extends AbstractAdapter {
     ...
     * @param msg         String
     */
    public AdapterReport createAdaptorReportAndUpdate(EventSource source, boolean isAvailable,
                                                      String msg) {
