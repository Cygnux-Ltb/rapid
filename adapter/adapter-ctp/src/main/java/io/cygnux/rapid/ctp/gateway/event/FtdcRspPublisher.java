...
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeDepthMarketData;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeFrontDisconnected;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeHeartBeatWarning;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeInputOrder;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeInputOrderAction;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeInstrumentStatus;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeInvestorPosition;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeOrder;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeOrderAction;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeRspError;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeRspUserLogin;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeRspUserLogout;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeSpecificInstrument;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeTrade;
import static io.cygnux.rapid.ctp.gateway.event.FtdcRspFieldWriter.writeTradingAccount;
