...
import io.cygnux.rapid.ctp.adaptor.CtpAdapter;
import io.cygnux.rapid.ctp.adaptor.FtdcRspHandler;
...
public class CtpAdapterService {
    ...
    private void start() {
        try {
            adapter.startup();
            log.info("Adaptor -> {} STARTED, wait 2 seconds.", adapter.getAdaptorId());
            Sleep.millis(2000);
