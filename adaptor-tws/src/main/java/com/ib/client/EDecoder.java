...
class EDecoder implements ObjectInput {
    ...
    private void processTickPriceMsg() throws IOException {
        ...
        if (version >= 2) {
            final int sizeTickType = switch (tickType) {
                case 1 -> // BID
                        0; // BID_SIZE
                case 2 -> // ASK
                        3; // ASK_SIZE
    ...
    private void processCompletedOrdersEndMsg() {
    ...
    @Override
    public void readFully(@Nonnull byte[] arg0, int arg1, int arg2) {
        throw new UnsupportedOperationException();
    }

    @Override
    public void readFully(@Nonnull byte[] arg0) {
        throw new UnsupportedOperationException();
    }
