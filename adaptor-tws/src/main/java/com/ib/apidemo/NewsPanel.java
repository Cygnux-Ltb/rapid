    ...
    static class NewsProvidersPanel extends NewTabPanel implements INewsProvidersHandler {
        ...
        class NewsProvidersModel extends AbstractTableModel {
            ...
            public Object getValueAt(int rowIn, int col) {
                ...
                return switch (col) {
                    case 0 -> newsProvidersRow.m_providerCode;
                    case 1 -> newsProvidersRow.m_providerName;
                    default -> null;
                };
            }
        }
    ...
    class NewsTicksResultsPanel extends NewTabPanel implements ITickNewsHandler {
        ...
        class NewsTicksModel extends AbstractTableModel {
            ...
            public Object getValueAt(int rowIn, int col) {
                ...
                return switch (col) {
                    case 0 -> newsTickRow.m_timeStamp;
                    case 1 -> newsTickRow.m_providerCode;
                    case 2 -> newsTickRow.m_articleId;
                    case 3 -> newsTickRow.m_headline;
                    case 4 -> newsTickRow.m_extraData;
                    default -> null;
                };
            }
        }
    ...
    class HistoricalNewsResultsPanel extends NewTabPanel implements IHistoricalNewsHandler {
        ...
        class HistoricalNewsModel extends AbstractTableModel {
            ...
            public Object getValueAt(int rowIn, int col) {
                ...
                return switch (col) {
                    case 0 -> historicalNewsRow.m_time;
                    case 1 -> historicalNewsRow.m_providerCode;
                    case 2 -> historicalNewsRow.m_articleId;
                    case 3 -> historicalNewsRow.m_headline;
                    default -> null;
                };
            }
        }
