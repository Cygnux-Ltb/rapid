        ...
        class SmartComponentsModel extends AbstractTableModel {
            ...
            public String getColumnName(int col) {
                return switch (col) {
                    ...
                    case 1 -> "Bit Number";
                    case 2 -> "Exchange";
                    case 3 -> "Exchange single-letter abbreviation";
                    default -> null;
                };
            }
            ...
            public Object getValueAt(int rowIn, int col) {
                ...
                return switch (col) {
                    case 0 -> symbolSamplesRow.m_reqId;
                    case 1 -> symbolSamplesRow.m_bitNum;
                    case 2 -> symbolSamplesRow.m_exch;
                    case 3 -> symbolSamplesRow.m_exchLetter;
                    default -> null;
                };
            }
        }
    ...
    static class SymbolSamplesPanel extends NewTabPanel implements ISymbolSamplesHandler {
        ...
        class SymbolSamplesModel extends AbstractTableModel {
            ...
            public Object getValueAt(int rowIn, int col) {
                ...
                return switch (col) {
                    case 0 -> symbolSamplesRow.m_conId;
                    case 1 -> symbolSamplesRow.m_symbol;
                    case 2 -> symbolSamplesRow.m_secType;
                    case 3 -> symbolSamplesRow.m_primaryExch;
                    case 4 -> symbolSamplesRow.m_currency;
                    case 5 -> symbolSamplesRow.m_derivativeSecTypes;
                    default -> null;
                };
            }
        }
