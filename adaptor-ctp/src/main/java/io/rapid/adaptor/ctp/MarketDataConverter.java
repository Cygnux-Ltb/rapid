...
public final class MarketDataConverter {
    ...
    private static final Logger log = getLogger(MarketDataConverter.class);
    ...
    public FastMarketData withFtdcDepthMarketData(FtdcDepthMarketData depthMarketData) {
        ...
        var updateTime = LocalTime.parse(depthMarketData.getUpdateTime(), updateTimeFormatter)
                .plusNanos(depthMarketData.getUpdateMillisec() * NANOS_PER_MILLIS);
        // 最后修改时间
        var instrument = getInstrument(depthMarketData.getInstrumentID());
