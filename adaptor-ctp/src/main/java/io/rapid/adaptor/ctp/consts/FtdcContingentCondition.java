...
public interface FtdcContingentCondition {
     ...
     * 最新价大于条件价
     */
    char LAST_PRICE_GREATER_THAN_STOP_PRICE = '5';

    /**
     * 最新价大于等于条件价
     */
    char LAST_PRICE_GREATER_EQUAL_STOP_PRICE = '6';

    /**
     * 最新价小于条件价
     */
    char LAST_PRICE_LESSER_THAN_STOP_PRICE = '7';

    /**
     * 最新价小于等于条件价
     */
    char LAST_PRICE_LESSER_EQUAL_STOP_PRICE = '8';

    /**
     * 卖一价大于条件价
     */
    char ASK_PRICE_GREATER_THAN_STOP_PRICE = '9';

    /**
     * 卖一价大于等于条件价
     */
    char ASK_PRICE_GREATER_EQUAL_STOP_PRICE = 'A';

    /**
     * 卖一价小于条件价
     */
    char ASK_PRICE_LESSER_THAN_STOP_PRICE = 'B';

    /**
     * 卖一价小于等于条件价
     */
    char ASK_PRICE_LESSER_EQUAL_STOP_PRICE = 'C';

    /**
     * 买一价大于条件价
     */
    char BID_PRICE_GREATER_THAN_STOP_PRICE = 'D';

    /**
     * 买一价大于等于条件价
     */
    char BID_PRICE_GREATER_EQUAL_STOP_PRICE = 'E';

    /**
     * 买一价小于条件价
     */
    char BID_PRICE_LESSER_THAN_STOP_PRICE = 'F';

    /**
     * 买一价小于等于条件价
     */
    char BID_PRICE_LESSER_EQUAL_STOP_PRICE = 'H';
