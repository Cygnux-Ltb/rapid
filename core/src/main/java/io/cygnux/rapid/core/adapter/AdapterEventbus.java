...
public abstract class AdapterEventbus extends RingEventHandler<AdapterEvent> {

    /**
     * 默认使用单生产者
     */
    protected AdapterEventbus() {
     ...
     */
    protected AdapterEventbus(Builder builder) {
        super(builder.name("outbound-eventbus"), AdapterEvent.EVENT_FACTORY);
    }
