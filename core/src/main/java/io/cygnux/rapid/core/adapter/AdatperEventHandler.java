 ...
 * @author yellow013
 */
public interface AdatperEventHandler extends EventHandler<AdapterEvent>,
        // 用于清理资源
        Closeable {

    @Override
    default void onEvent(AdapterEvent event, long sequence, boolean endOfBatch) throws Exception {
