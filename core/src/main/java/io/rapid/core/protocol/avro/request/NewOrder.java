...
public class NewOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7584865217646821526L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewOrder\",\"namespace\":\"io.rapid.core.protocol.avro.request\",\"doc\":\"新订单\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\"},{\"name\":\"sendTime\",\"type\":\"long\"},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"offerQty\",\"type\":\"int\"},{\"name\":\"minimumQty\",\"type\":\"int\",\"default\":1},{\"name\":\"offerPrice\",\"type\":\"double\",\"default\":0.0},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentId\",\"type\":\"int\"},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"OrdType\",\"namespace\":\"io.rapid.core.protocol.avro.enums\",\"symbols\":[\"INVALID\",\"LIMITED\",\"MARKET\",\"LIMITED_STOP\",\"MARKET_STOP\",\"MTL\",\"BP\",\"AP\",\"FOK\",\"FAK\",\"MV\"]}},{\"name\":\"valid\",\"type\":{\"type\":\"enum\",\"name\":\"OrdValid\",\"namespace\":\"io.rapid.core.protocol.avro.enums\",\"symbols\":[\"GTC\",\"GTD\",\"GFD\"]}},{\"name\":\"action\",\"type\":{\"type\":\"enum\",\"name\":\"TrdAction\",\"namespace\":\"io.rapid.core.protocol.avro.enums\",\"symbols\":[\"INVALID\",\"OPEN\",\"CLOSE\",\"CLOSE_TODAY\",\"CLOSE_YESTERDAY\"]}},{\"name\":\"direction\",\"type\":{\"type\":\"enum\",\"name\":\"TrdDirection\",\"namespace\":\"io.rapid.core.protocol.avro.enums\",\"symbols\":[\"INVALID\",\"LONG\",\"SHORT\"]}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"msg\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  ...
  private io.rapid.core.protocol.avro.enums.OrdType type;
  private io.rapid.core.protocol.avro.enums.OrdValid valid;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 9: type = (io.rapid.core.protocol.avro.enums.OrdType)value$; break;
    case 10: valid = (io.rapid.core.protocol.avro.enums.OrdValid)value$; break;
    case 11: action = (io.rapid.core.protocol.avro.enums.TrdAction)value$; break;
    case 12: direction = (io.rapid.core.protocol.avro.enums.TrdDirection)value$; break;
   ...
   */
  public io.rapid.core.protocol.avro.enums.OrdType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public NewOrder setType(io.rapid.core.protocol.avro.enums.OrdType value) {
    this.type = value;
    return this;
  }
   ...
   */
  public io.rapid.core.protocol.avro.enums.OrdValid getValid() {
    return valid;
  }
   ...
   * @param value the value to set.
   */
  public NewOrder setValid(io.rapid.core.protocol.avro.enums.OrdValid value) {
    this.valid = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public NewOrder setAction(io.rapid.core.protocol.avro.enums.TrdAction value) {
    this.action = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public NewOrder setDirection(io.rapid.core.protocol.avro.enums.TrdDirection value) {
   ...
   */
  public static io.rapid.core.protocol.avro.request.NewOrder.Builder newBuilder() {
    return new io.rapid.core.protocol.avro.request.NewOrder.Builder();
  }
   ...
   * @return A new NewOrder RecordBuilder
   */
  public static io.rapid.core.protocol.avro.request.NewOrder.Builder newBuilder(io.rapid.core.protocol.avro.request.NewOrder.Builder other) {
    if (other == null) {
      return new io.rapid.core.protocol.avro.request.NewOrder.Builder();
    } else {
      return new io.rapid.core.protocol.avro.request.NewOrder.Builder(other);
    }
  }
   ...
   * @return A new NewOrder RecordBuilder
   */
  public static io.rapid.core.protocol.avro.request.NewOrder.Builder newBuilder(io.rapid.core.protocol.avro.request.NewOrder other) {
    if (other == null) {
      return new io.rapid.core.protocol.avro.request.NewOrder.Builder();
    } else {
      return new io.rapid.core.protocol.avro.request.NewOrder.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewOrder>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.protocol.avro.request.NewOrder.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.protocol.avro.request.NewOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setOfferQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearOfferQty() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setMinimumQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearMinimumQty() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setOfferPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearOfferPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setInstrumentId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearInstrumentId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setType(io.rapid.core.protocol.avro.enums.OrdType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setValid(io.rapid.core.protocol.avro.enums.OrdValid value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearValid() {
      valid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setAction(io.rapid.core.protocol.avro.enums.TrdAction value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearAction() {
      action = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setDirection(io.rapid.core.protocol.avro.enums.TrdDirection value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearDirection() {
      direction = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearOperatorId() {
      operatorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder setMsg(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.protocol.avro.request.NewOrder.Builder clearMsg() {
      msg = null;
    ...
    public NewOrder build() {
      try {
        ...
        record.type = fieldSetFlags()[9] ? this.type : (io.rapid.core.protocol.avro.enums.OrdType) defaultValue(fields()[9]);
        record.valid = fieldSetFlags()[10] ? this.valid : (io.rapid.core.protocol.avro.enums.OrdValid) defaultValue(fields()[10]);
        record.action = fieldSetFlags()[11] ? this.action : (io.rapid.core.protocol.avro.enums.TrdAction) defaultValue(fields()[11]);
        record.direction = fieldSetFlags()[12] ? this.direction : (io.rapid.core.protocol.avro.enums.TrdDirection) defaultValue(fields()[12]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.type = io.rapid.core.protocol.avro.enums.OrdType.values()[in.readEnum()];

      this.valid = io.rapid.core.protocol.avro.enums.OrdValid.values()[in.readEnum()];
