...
public class MarketDataSubscribeEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    private io.rapid.core.protocol.avro.enums.SubscribeStatus status;
     ...
     */
    public MarketDataSubscribeEvent(io.rapid.core.protocol.avro.enums.SubscribeStatus status, java.util.List<java.lang.String> successInstrumentCodes, java.util.List<java.lang.String> failInstrumentCodes, java.lang.String msg) {
        this.status = status;
    ...
    public java.lang.Object get(int field$) {
        return switch (field$) {
            case 0 -> status;
            case 1 -> successInstrumentCodes;
            case 2 -> failInstrumentCodes;
            case 3 -> msg;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                status = (io.rapid.core.protocol.avro.enums.SubscribeStatus) value$;
                break;
            case 1:
     ...
     */
    public io.rapid.core.protocol.avro.enums.SubscribeStatus getStatus() {
        return status;
    }
     ...
     */
    public MarketDataSubscribeEvent setStatus(io.rapid.core.protocol.avro.enums.SubscribeStatus value) {
        this.status = value;
        return this;
    }
     ...
     */
    public static io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder newBuilder() {
        return new io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder();
    }
     ...
     * @return A new MarketDataSubscribeEvent RecordBuilder
     */
    public static io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder newBuilder(io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder other) {
        if (other == null) {
            return new io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder();
        } else {
            return new io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder(other);
        }
    }
     ...
     * @return A new MarketDataSubscribeEvent RecordBuilder
     */
    public static io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder newBuilder(io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent other) {
        if (other == null) {
            return new io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder();
        } else {
            return new io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribeEvent>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.status)) {
                this.status = data().deepCopy(fields()[0].schema(), other.status);
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder setStatus(io.rapid.core.protocol.avro.enums.SubscribeStatus value) {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder clearStatus() {
            status = null;
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder setSuccessInstrumentCodes(java.util.List<java.lang.String> value) {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder clearSuccessInstrumentCodes() {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder setFailInstrumentCodes(java.util.List<java.lang.String> value) {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder clearFailInstrumentCodes() {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder setMsg(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.rapid.core.protocol.avro.event.MarketDataSubscribeEvent.Builder clearMsg() {
            msg = null;
        ...
        public MarketDataSubscribeEvent build() {
            try {
                ...
                record.status = fieldSetFlags()[0] ? this.status : (io.rapid.core.protocol.avro.enums.SubscribeStatus) defaultValue(fields()[0]);
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in)
        ...
        if (fieldOrder == null) {
            this.status = io.rapid.core.protocol.avro.enums.SubscribeStatus.values()[in.readEnum()];
