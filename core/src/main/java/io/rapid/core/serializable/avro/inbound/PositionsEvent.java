...
public class PositionsEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4998545579957525331L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PositionsEvent\",\"namespace\":\"io.rapid.core.serializable.avro.inbound\",\"doc\":\"持仓回报\",\"fields\":[{\"name\":\"epochMillis\",\"type\":\"long\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"investorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"direction\",\"type\":{\"type\":\"enum\",\"name\":\"TrdDirection\",\"namespace\":\"io.rapid.core.serializable.avro.enums\",\"symbols\":[\"INVALID\",\"LONG\",\"SHORT\"]}},{\"name\":\"qty\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<PositionsEvent> ENCODER =
      new BinaryMessageEncoder<PositionsEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PositionsEvent> DECODER =
      new BinaryMessageDecoder<PositionsEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<PositionsEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<PositionsEvent>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public PositionsEvent(java.lang.Long epochMillis, java.lang.String brokerId, java.lang.String investorId, java.lang.String exchangeCode, java.lang.String instrumentCode, io.rapid.core.serializable.avro.enums.TrdDirection direction, java.lang.Integer qty) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: direction = (io.rapid.core.serializable.avro.enums.TrdDirection)value$; break;
    case 6: qty = (java.lang.Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @param value the value to set.
   */
  public PositionsEvent setDirection(io.rapid.core.serializable.avro.enums.TrdDirection value) {
   ...
   */
  public static io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder newBuilder() {
    return new io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder();
  }
   ...
   * @return A new PositionsEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder newBuilder(io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder(other);
    }
  }
   ...
   * @return A new PositionsEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder newBuilder(io.rapid.core.serializable.avro.inbound.PositionsEvent other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PositionsEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[6], other.qty)) {
        this.qty = data().deepCopy(fields()[6].schema(), other.qty);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.serializable.avro.inbound.PositionsEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMillis)) {
        this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setEpochMillis(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearEpochMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setInvestorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearInvestorId() {
      investorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setDirection(io.rapid.core.serializable.avro.enums.TrdDirection value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearDirection() {
      direction = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder setQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.PositionsEvent.Builder clearQty() {
    ...
    public PositionsEvent build() {
      try {
        ...
        record.direction = fieldSetFlags()[5] ? this.direction : (io.rapid.core.serializable.avro.enums.TrdDirection) defaultValue(fields()[5]);
        record.qty = fieldSetFlags()[6] ? this.qty : (java.lang.Integer) defaultValue(fields()[6]);
        return record;
