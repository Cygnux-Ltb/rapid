...
public class MarketDataSubscribeEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder newBuilder() {
    return new io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder();
  }
   ...
   * @return A new MarketDataSubscribeEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder newBuilder(io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder(other);
    }
  }
   ...
   * @return A new MarketDataSubscribeEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder newBuilder(io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribeEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.status)) {
        this.status = data().deepCopy(fields()[0].schema(), other.status);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder setStatus(io.rapid.core.serializable.avro.enums.SubscribeStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder setSuccessInstrumentCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder clearSuccessInstrumentCodes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder setFailInstrumentCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder clearFailInstrumentCodes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder setMsg(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.event.MarketDataSubscribeEvent.Builder clearMsg() {
      msg = null;
