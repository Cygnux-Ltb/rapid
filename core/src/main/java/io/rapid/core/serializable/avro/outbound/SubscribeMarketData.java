...
public class SubscribeMarketData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder newBuilder() {
    return new io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder();
  }
   ...
   * @return A new SubscribeMarketData RecordBuilder
   */
  public static io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder newBuilder(io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder();
    } else {
      return new io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder(other);
    }
  }
   ...
   * @return A new SubscribeMarketData RecordBuilder
   */
  public static io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder newBuilder(io.rapid.core.serializable.avro.outbound.SubscribeMarketData other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder();
    } else {
      return new io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubscribeMarketData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.serializable.avro.outbound.SubscribeMarketData other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder setType(io.rapid.core.serializable.avro.enums.MarketDataType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder setRecvAddr(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.outbound.SubscribeMarketData.Builder clearRecvAddr() {
      recvAddr = null;
