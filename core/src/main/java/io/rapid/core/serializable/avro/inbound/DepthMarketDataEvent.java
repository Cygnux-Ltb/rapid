...
public class DepthMarketDataEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -429003130057663772L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DepthMarketDataEvent\",\"namespace\":\"io.rapid.core.serializable.avro.inbound\",\"doc\":\"深度行情数据结构\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"instrumentId\",\"type\":\"int\"},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastPrice\",\"type\":\"double\"},{\"name\":\"volume\",\"type\":\"int\"},{\"name\":\"turnover\",\"type\":\"long\"},{\"name\":\"bidPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"bidVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"askPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"askVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"depth\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<DepthMarketDataEvent> ENCODER =
      new BinaryMessageEncoder<DepthMarketDataEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DepthMarketDataEvent> DECODER =
      new BinaryMessageDecoder<DepthMarketDataEvent>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<DepthMarketDataEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DepthMarketDataEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DepthMarketDataEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DepthMarketDataEvent>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DepthMarketDataEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a DepthMarketDataEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DepthMarketDataEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DepthMarketDataEvent fromByteBuffer(
   ...
   */
  public DepthMarketDataEvent setTimestamp(long value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setInstrumentId(int value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setLastPrice(double value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setVolume(int value) {
    this.volume = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setTurnover(long value) {
    this.turnover = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setBidPrices(java.util.List<java.lang.Double> value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setBidVolumes(java.util.List<java.lang.Integer> value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setAskPrices(java.util.List<java.lang.Double> value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setAskVolumes(java.util.List<java.lang.Integer> value) {
   ...
   * @param value the value to set.
   */
  public DepthMarketDataEvent setDepth(int value) {
    this.depth = value;
    return this;
  }

  /**
   * Creates a new DepthMarketDataEvent RecordBuilder.
   * @return A new DepthMarketDataEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder newBuilder() {
    return new io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder();
  }

  /**
   * Creates a new DepthMarketDataEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DepthMarketDataEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder newBuilder(io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder(other);
    }
  }

  /**
   * Creates a new DepthMarketDataEvent RecordBuilder by copying an existing DepthMarketDataEvent instance.
   * @param other The existing instance to copy.
   * @return A new DepthMarketDataEvent RecordBuilder
   */
  public static io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder newBuilder(io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent other) {
    if (other == null) {
      return new io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder();
    } else {
      return new io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder(other);
  ...
  /**
   * RecordBuilder for DepthMarketDataEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DepthMarketDataEvent>
    implements org.apache.avro.data.RecordBuilder<DepthMarketDataEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DepthMarketDataEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.timestamp)) {
        this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setInstrumentId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearInstrumentId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setLastPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearLastPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setVolume(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearVolume() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setTurnover(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearTurnover() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setBidPrices(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearBidPrices() {
      bidPrices = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setBidVolumes(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearBidVolumes() {
      bidVolumes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setAskPrices(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearAskPrices() {
      askPrices = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setAskVolumes(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearAskVolumes() {
      askVolumes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder setDepth(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.rapid.core.serializable.avro.inbound.DepthMarketDataEvent.Builder clearDepth() {
      fieldSetFlags()[10] = false;
      return this;
    }

    @Override
    public DepthMarketDataEvent build() {
      try {
        DepthMarketDataEvent record = new DepthMarketDataEvent();
  ...
  private static final org.apache.avro.io.DatumWriter<DepthMarketDataEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<DepthMarketDataEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DepthMarketDataEvent>
    READER$ = (org.apache.avro.io.DatumReader<DepthMarketDataEvent>)MODEL$.createDatumReader(SCHEMA$);
