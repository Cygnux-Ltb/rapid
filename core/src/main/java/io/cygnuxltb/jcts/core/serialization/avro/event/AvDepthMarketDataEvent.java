...
public class AvDepthMarketDataEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 9161089666327829930L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvDepthMarketDataEvent\",\"namespace\":\"io.cygnuxltb.jcts.core.serialization.avro.event\",\"doc\":\"深度行情数据结构\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"instrumentId\",\"type\":\"int\"},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastPrice\",\"type\":\"double\"},{\"name\":\"volume\",\"type\":\"int\"},{\"name\":\"turnover\",\"type\":\"long\"},{\"name\":\"bidPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"bidVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"askPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"askVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"depth\",\"type\":\"int\"}]}");
    ...
    private static final BinaryMessageEncoder<AvDepthMarketDataEvent> ENCODER =
            new BinaryMessageEncoder<AvDepthMarketDataEvent>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<AvDepthMarketDataEvent> DECODER =
            new BinaryMessageDecoder<AvDepthMarketDataEvent>(MODEL$, SCHEMA$);

    /**
     * Return the BinaryMessageEncoder instance used by this class.
     * @return the message encoder used by this class
     */
    public static BinaryMessageEncoder<AvDepthMarketDataEvent> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AvDepthMarketDataEvent> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AvDepthMarketDataEvent> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<AvDepthMarketDataEvent>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Serializes this AvDepthMarketDataEvent to a ByteBuffer.
    ...
    /**
     * Deserializes a AvDepthMarketDataEvent from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a AvDepthMarketDataEvent instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static AvDepthMarketDataEvent fromByteBuffer(
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 5:
                ...
                break;
            case 6:
                bidPrices = (java.util.List<java.lang.Double>) value$;
                break;
            case 7:
                bidVolumes = (java.util.List<java.lang.Integer>) value$;
                break;
            case 8:
                askPrices = (java.util.List<java.lang.Double>) value$;
                break;
            case 9:
     ...
     */
    public AvDepthMarketDataEvent setTimestamp(long value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setInstrumentId(int value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setInstrumentCode(java.lang.String value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setLastPrice(double value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setVolume(int value) {
        this.volume = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setTurnover(long value) {
        this.turnover = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setBidPrices(java.util.List<java.lang.Double> value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setBidVolumes(java.util.List<java.lang.Integer> value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setAskPrices(java.util.List<java.lang.Double> value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setAskVolumes(java.util.List<java.lang.Integer> value) {
     ...
     * @param value the value to set.
     */
    public AvDepthMarketDataEvent setDepth(int value) {
        this.depth = value;
        return this;
    }

    /**
     * Creates a new AvDepthMarketDataEvent RecordBuilder.
     * @return A new AvDepthMarketDataEvent RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder newBuilder() {
        return new io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder();
    }

    /**
     * Creates a new AvDepthMarketDataEvent RecordBuilder by copying an existing Builder.
     * @param other The existing builder to copy.
     * @return A new AvDepthMarketDataEvent RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder(other);
        }
    }

    /**
     * Creates a new AvDepthMarketDataEvent RecordBuilder by copying an existing AvDepthMarketDataEvent instance.
     * @param other The existing instance to copy.
     * @return A new AvDepthMarketDataEvent RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder(other);
    ...
    /**
     * RecordBuilder for AvDepthMarketDataEvent instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvDepthMarketDataEvent>
            implements org.apache.avro.data.RecordBuilder<AvDepthMarketDataEvent> {
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder other) {
            super(other);
        ...
        /**
         * Creates a Builder by copying an existing AvDepthMarketDataEvent instance
         * @param other The existing instance to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.timestamp)) {
                this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setTimestamp(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearTimestamp() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setInstrumentId(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearInstrumentId() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setInstrumentCode(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearInstrumentCode() {
            instrumentCode = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setLastPrice(double value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearLastPrice() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setVolume(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearVolume() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setTurnover(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearTurnover() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setBidPrices(java.util.List<java.lang.Double> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearBidPrices() {
            bidPrices = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setBidVolumes(java.util.List<java.lang.Integer> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearBidVolumes() {
            bidVolumes = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setAskPrices(java.util.List<java.lang.Double> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearAskPrices() {
            askPrices = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setAskVolumes(java.util.List<java.lang.Integer> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearAskVolumes() {
            askVolumes = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder setDepth(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.event.AvDepthMarketDataEvent.Builder clearDepth() {
            fieldSetFlags()[10] = false;
            return this;
        }

        @Override
        public AvDepthMarketDataEvent build() {
            try {
                AvDepthMarketDataEvent record = new AvDepthMarketDataEvent();
    ...
    private static final org.apache.avro.io.DatumWriter<AvDepthMarketDataEvent>
            WRITER$ = (org.apache.avro.io.DatumWriter<AvDepthMarketDataEvent>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<AvDepthMarketDataEvent>
            READER$ = (org.apache.avro.io.DatumReader<AvDepthMarketDataEvent>) MODEL$.createDatumReader(SCHEMA$);
