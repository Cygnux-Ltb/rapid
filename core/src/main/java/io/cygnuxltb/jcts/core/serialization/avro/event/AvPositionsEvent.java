...
public class AvPositionsEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3973576710479291059L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvPositionsEvent\",\"namespace\":\"io.cygnuxltb.jcts.core.serialization.avro.event\",\"doc\":\"持仓回报\",\"fields\":[{\"name\":\"epochMillis\",\"type\":\"long\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"investorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"qty\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvPositionsEvent> ENCODER =
      new BinaryMessageEncoder<AvPositionsEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvPositionsEvent> DECODER =
      new BinaryMessageDecoder<AvPositionsEvent>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AvPositionsEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvPositionsEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvPositionsEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvPositionsEvent>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AvPositionsEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a AvPositionsEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AvPositionsEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AvPositionsEvent fromByteBuffer(
   ...
   */
  public AvPositionsEvent(java.lang.Long epochMillis, java.lang.String brokerId, java.lang.String investorId, java.lang.String exchangeCode, java.lang.String instrumentCode, java.lang.Integer qty) {
   ...
   */
  public AvPositionsEvent setEpochMillis(long value) {
   ...
   * @param value the value to set.
   */
  public AvPositionsEvent setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvPositionsEvent setInvestorId(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvPositionsEvent setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvPositionsEvent setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvPositionsEvent setQty(int value) {
    this.qty = value;
    return this;
  }

  /**
   * Creates a new AvPositionsEvent RecordBuilder.
   * @return A new AvPositionsEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder();
  }

  /**
   * Creates a new AvPositionsEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvPositionsEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder(other);
    }
  }

  /**
   * Creates a new AvPositionsEvent RecordBuilder by copying an existing AvPositionsEvent instance.
   * @param other The existing instance to copy.
   * @return A new AvPositionsEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder(other);
  ...
  /**
   * RecordBuilder for AvPositionsEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvPositionsEvent>
    implements org.apache.avro.data.RecordBuilder<AvPositionsEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvPositionsEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMillis)) {
        this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setEpochMillis(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearEpochMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setInvestorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearInvestorId() {
      investorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder setQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.event.AvPositionsEvent.Builder clearQty() {
      fieldSetFlags()[5] = false;
      return this;
    }

    @Override
    public AvPositionsEvent build() {
      try {
        AvPositionsEvent record = new AvPositionsEvent();
  ...
  private static final org.apache.avro.io.DatumWriter<AvPositionsEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvPositionsEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvPositionsEvent>
    READER$ = (org.apache.avro.io.DatumReader<AvPositionsEvent>)MODEL$.createDatumReader(SCHEMA$);
