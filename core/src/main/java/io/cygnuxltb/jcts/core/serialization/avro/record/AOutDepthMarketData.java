...
public class AOutDepthMarketData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 4701305047640622082L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AOutDepthMarketData\",\"namespace\":\"io.cygnuxltb.jcts.core.serialization.avro.record\",\"doc\":\"深度行情数据结构\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"instrumentId\",\"type\":\"int\"},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastPrice\",\"type\":\"double\"},{\"name\":\"volume\",\"type\":\"int\"},{\"name\":\"turnover\",\"type\":\"long\"},{\"name\":\"bidPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"bidVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"askPrices\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"askVolumes\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"depth\",\"type\":\"int\"}]}");
    ...
    private static final BinaryMessageEncoder<AOutDepthMarketData> ENCODER =
            new BinaryMessageEncoder<AOutDepthMarketData>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<AOutDepthMarketData> DECODER =
            new BinaryMessageDecoder<AOutDepthMarketData>(MODEL$, SCHEMA$);

    /**
     * Return the BinaryMessageEncoder instance used by this class.
     * @return the message encoder used by this class
     */
    public static BinaryMessageEncoder<AOutDepthMarketData> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AOutDepthMarketData> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AOutDepthMarketData> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<AOutDepthMarketData>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Serializes this AOutDepthMarketData to a ByteBuffer.
    ...
    /**
     * Deserializes a AOutDepthMarketData from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a AOutDepthMarketData instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static AOutDepthMarketData fromByteBuffer(
     ...
     */
    public AOutDepthMarketData setTimestamp(long value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setInstrumentId(int value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setInstrumentCode(java.lang.String value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setLastPrice(double value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setVolume(int value) {
        this.volume = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setTurnover(long value) {
        this.turnover = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setBidPrices(java.util.List<java.lang.Double> value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setBidVolumes(java.util.List<java.lang.Integer> value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setAskPrices(java.util.List<java.lang.Double> value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setAskVolumes(java.util.List<java.lang.Integer> value) {
     ...
     * @param value the value to set.
     */
    public AOutDepthMarketData setDepth(int value) {
        this.depth = value;
        return this;
    }

    /**
     * Creates a new AOutDepthMarketData RecordBuilder.
     * @return A new AOutDepthMarketData RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder newBuilder() {
        return new io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder();
    }

    /**
     * Creates a new AOutDepthMarketData RecordBuilder by copying an existing Builder.
     * @param other The existing builder to copy.
     * @return A new AOutDepthMarketData RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder(other);
        }
    }

    /**
     * Creates a new AOutDepthMarketData RecordBuilder by copying an existing AOutDepthMarketData instance.
     * @param other The existing instance to copy.
     * @return A new AOutDepthMarketData RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder(other);
    ...
    /**
     * RecordBuilder for AOutDepthMarketData instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AOutDepthMarketData>
            implements org.apache.avro.data.RecordBuilder<AOutDepthMarketData> {
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder other) {
            super(other);
        ...
        /**
         * Creates a Builder by copying an existing AOutDepthMarketData instance
         * @param other The existing instance to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.timestamp)) {
                this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setTimestamp(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearTimestamp() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setInstrumentId(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearInstrumentId() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setInstrumentCode(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearInstrumentCode() {
            instrumentCode = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setLastPrice(double value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearLastPrice() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setVolume(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearVolume() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setTurnover(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearTurnover() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setBidPrices(java.util.List<java.lang.Double> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearBidPrices() {
            bidPrices = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setBidVolumes(java.util.List<java.lang.Integer> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearBidVolumes() {
            bidVolumes = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setAskPrices(java.util.List<java.lang.Double> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearAskPrices() {
            askPrices = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setAskVolumes(java.util.List<java.lang.Integer> value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearAskVolumes() {
            askVolumes = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder setDepth(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AOutDepthMarketData.Builder clearDepth() {
            fieldSetFlags()[10] = false;
            return this;
        }

        @Override
        public AOutDepthMarketData build() {
            try {
                AOutDepthMarketData record = new AOutDepthMarketData();
    ...
    private static final org.apache.avro.io.DatumWriter<AOutDepthMarketData>
            WRITER$ = (org.apache.avro.io.DatumWriter<AOutDepthMarketData>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<AOutDepthMarketData>
            READER$ = (org.apache.avro.io.DatumReader<AOutDepthMarketData>) MODEL$.createDatumReader(SCHEMA$);
