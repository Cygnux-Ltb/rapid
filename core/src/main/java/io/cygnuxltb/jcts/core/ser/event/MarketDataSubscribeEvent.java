...
public class MarketDataSubscribeEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4143439186950310882L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MarketDataSubscribeEvent\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.event\",\"doc\":\"行情订阅回报\",\"fields\":[{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"SubscribeStatus\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.enums\",\"doc\":\"行情订阅状态\",\"symbols\":[\"SUCCEED\",\"PART_SUCCEED\",\"FAILED\"]}},{\"name\":\"successInstrumentCodes\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}},{\"name\":\"failInstrumentCodes\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}},{\"name\":\"msg\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  ...
  private io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus status;
   ...
   */
  public MarketDataSubscribeEvent(io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus status, java.util.List<java.lang.String> successInstrumentCodes, java.util.List<java.lang.String> failInstrumentCodes, java.lang.String msg) {
    this.status = status;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: status = (io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus)value$; break;
   ...
   */
  public io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus getStatus() {
    return status;
  }
   ...
   */
  public MarketDataSubscribeEvent setStatus(io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus value) {
    this.status = value;
    return this;
  }
   ...
   */
  public static io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder();
  }
   ...
   * @return A new MarketDataSubscribeEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder(other);
    }
  }
   ...
   * @return A new MarketDataSubscribeEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribeEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.status)) {
        this.status = data().deepCopy(fields()[0].schema(), other.status);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder setStatus(io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder setSuccessInstrumentCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder clearSuccessInstrumentCodes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder setFailInstrumentCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder clearFailInstrumentCodes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder setMsg(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.MarketDataSubscribeEvent.Builder clearMsg() {
      msg = null;
    ...
    public MarketDataSubscribeEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[0] ? this.status : (io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.status = io.cygnuxltb.jcts.core.ser.enums.SubscribeStatus.values()[in.readEnum()];
