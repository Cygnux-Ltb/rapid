...
public class AInQueryPositions extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 4309359984709776819L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AInQueryPositions\",\"namespace\":\"io.cygnuxltb.jcts.core.serialization.avro.record\",\"doc\":\"查询账户持仓\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
    ...
    private static final BinaryMessageEncoder<AInQueryPositions> ENCODER =
            new BinaryMessageEncoder<AInQueryPositions>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<AInQueryPositions> DECODER =
            new BinaryMessageDecoder<AInQueryPositions>(MODEL$, SCHEMA$);

    /**
     * Return the BinaryMessageEncoder instance used by this class.
     * @return the message encoder used by this class
     */
    public static BinaryMessageEncoder<AInQueryPositions> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AInQueryPositions> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<AInQueryPositions> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<AInQueryPositions>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Serializes this AInQueryPositions to a ByteBuffer.
    ...
    /**
     * Deserializes a AInQueryPositions from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a AInQueryPositions instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static AInQueryPositions fromByteBuffer(
     ...
     */
    public AInQueryPositions(java.lang.Long generateTime, java.lang.Long sendTime, java.lang.String exchangeCode, java.lang.String instrumentCode, java.lang.String brokerId, java.lang.Integer accountId, java.lang.Integer subAccountId, java.lang.Integer strategyId, java.lang.String operatorId) {
     ...
     */
    public AInQueryPositions setGenerateTime(long value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setSendTime(long value) {
        this.sendTime = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setExchangeCode(java.lang.String value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setInstrumentCode(java.lang.String value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setBrokerId(java.lang.String value) {
        this.brokerId = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setAccountId(int value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setSubAccountId(int value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setStrategyId(int value) {
     ...
     * @param value the value to set.
     */
    public AInQueryPositions setOperatorId(java.lang.String value) {
        this.operatorId = value;
        return this;
    }

    /**
     * Creates a new AInQueryPositions RecordBuilder.
     * @return A new AInQueryPositions RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder newBuilder() {
        return new io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder();
    }

    /**
     * Creates a new AInQueryPositions RecordBuilder by copying an existing Builder.
     * @param other The existing builder to copy.
     * @return A new AInQueryPositions RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder(other);
        }
    }

    /**
     * Creates a new AInQueryPositions RecordBuilder by copying an existing AInQueryPositions instance.
     * @param other The existing instance to copy.
     * @return A new AInQueryPositions RecordBuilder
     */
    public static io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions other) {
        if (other == null) {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder();
        } else {
            return new io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder(other);
    ...
    /**
     * RecordBuilder for AInQueryPositions instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AInQueryPositions>
            implements org.apache.avro.data.RecordBuilder<AInQueryPositions> {
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder other) {
            super(other);
        ...
        /**
         * Creates a Builder by copying an existing AInQueryPositions instance
         * @param other The existing instance to copy.
         */
        private Builder(io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.generateTime)) {
                this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setGenerateTime(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearGenerateTime() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setSendTime(long value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearSendTime() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setExchangeCode(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearExchangeCode() {
            exchangeCode = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setInstrumentCode(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearInstrumentCode() {
            instrumentCode = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setBrokerId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearBrokerId() {
            brokerId = null;
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setAccountId(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearAccountId() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setSubAccountId(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearSubAccountId() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setStrategyId(int value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearStrategyId() {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder setOperatorId(java.lang.String value) {
         ...
         * @return This builder.
         */
        public io.cygnuxltb.jcts.core.serialization.avro.record.AInQueryPositions.Builder clearOperatorId() {
            operatorId = null;
        ...
        @Override
        public AInQueryPositions build() {
            try {
                AInQueryPositions record = new AInQueryPositions();
    ...
    private static final org.apache.avro.io.DatumWriter<AInQueryPositions>
            WRITER$ = (org.apache.avro.io.DatumWriter<AInQueryPositions>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<AInQueryPositions>
            READER$ = (org.apache.avro.io.DatumReader<AInQueryPositions>) MODEL$.createDatumReader(SCHEMA$);
