...
public class BalanceEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder();
  }
   ...
   * @return A new BalanceEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder(other);
    }
  }
   ...
   * @return A new BalanceEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.BalanceEvent other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BalanceEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.BalanceEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMillis)) {
        this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder setEpochMillis(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder clearEpochMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder setInvestorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder clearInvestorId() {
      investorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder setAvailable(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder clearAvailable() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder setCurrencyId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.BalanceEvent.Builder clearCurrencyId() {
      currencyId = null;
