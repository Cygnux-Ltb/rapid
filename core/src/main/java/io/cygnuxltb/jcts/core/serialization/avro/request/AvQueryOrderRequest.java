...
public class AvQueryOrderRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9205607510914042762L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvQueryOrderRequest\",\"namespace\":\"io.cygnuxltb.jcts.core.serialization.avro.request\",\"doc\":\"查询订单\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvQueryOrderRequest> ENCODER =
      new BinaryMessageEncoder<AvQueryOrderRequest>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvQueryOrderRequest> DECODER =
      new BinaryMessageDecoder<AvQueryOrderRequest>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AvQueryOrderRequest> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvQueryOrderRequest> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvQueryOrderRequest> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvQueryOrderRequest>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AvQueryOrderRequest to a ByteBuffer.
  ...
  /**
   * Deserializes a AvQueryOrderRequest from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AvQueryOrderRequest instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AvQueryOrderRequest fromByteBuffer(
   ...
   */
  public AvQueryOrderRequest setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setOrdSysId(long value) {
    this.ordSysId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public AvQueryOrderRequest setOperatorId(java.lang.String value) {
    this.operatorId = value;
    return this;
  }

  /**
   * Creates a new AvQueryOrderRequest RecordBuilder.
   * @return A new AvQueryOrderRequest RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder();
  }

  /**
   * Creates a new AvQueryOrderRequest RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvQueryOrderRequest RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder(other);
    }
  }

  /**
   * Creates a new AvQueryOrderRequest RecordBuilder by copying an existing AvQueryOrderRequest instance.
   * @param other The existing instance to copy.
   * @return A new AvQueryOrderRequest RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder newBuilder(io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder(other);
  ...
  /**
   * RecordBuilder for AvQueryOrderRequest instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvQueryOrderRequest>
    implements org.apache.avro.data.RecordBuilder<AvQueryOrderRequest> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvQueryOrderRequest instance
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.serialization.avro.request.AvQueryOrderRequest.Builder clearOperatorId() {
      operatorId = null;
    ...
    @Override
    public AvQueryOrderRequest build() {
      try {
        AvQueryOrderRequest record = new AvQueryOrderRequest();
  ...
  private static final org.apache.avro.io.DatumWriter<AvQueryOrderRequest>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvQueryOrderRequest>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvQueryOrderRequest>
    READER$ = (org.apache.avro.io.DatumReader<AvQueryOrderRequest>)MODEL$.createDatumReader(SCHEMA$);
