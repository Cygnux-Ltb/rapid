...
public class OrderEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4241868485397906176L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderEvent\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.event\",\"doc\":\"订单回报\",\"fields\":[{\"name\":\"epochMicros\",\"type\":\"long\"},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"tradingDay\",\"type\":\"int\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"investorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"orderRef\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerOrdSysId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"OrdStatus\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.enums\",\"symbols\":[\"INVALID\",\"PENDING_NEW\",\"NEW\",\"NEW_REJECTED\",\"PARTIALLY_FILLED\",\"FILLED\",\"PENDING_CANCEL\",\"CANCELED\",\"CANCEL_REJECTED\",\"PENDING_REPLACE\",\"REPLACED\",\"SUSPENDED\",\"UNPROVIDED\"]}},{\"name\":\"direction\",\"type\":{\"type\":\"enum\",\"name\":\"TrdDirection\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.enums\",\"symbols\":[\"INVALID\",\"LONG\",\"SHORT\"]}},{\"name\":\"action\",\"type\":{\"type\":\"enum\",\"name\":\"TrdAction\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.enums\",\"symbols\":[\"INVALID\",\"OPEN\",\"CLOSE\",\"CLOSE_TODAY\",\"CLOSE_YESTERDAY\"]}},{\"name\":\"offerQty\",\"type\":\"int\",\"default\":0},{\"name\":\"filledQty\",\"type\":\"int\",\"default\":0},{\"name\":\"offerPrice\",\"type\":\"long\",\"default\":0},{\"name\":\"tradePrice\",\"type\":\"long\",\"default\":0},{\"name\":\"offerTime\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"updateTime\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"msg\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  ...
  private io.cygnuxltb.jcts.core.ser.enums.OrdStatus status;
  private io.cygnuxltb.jcts.core.ser.enums.TrdDirection direction;
  private io.cygnuxltb.jcts.core.ser.enums.TrdAction action;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 9: status = (io.cygnuxltb.jcts.core.ser.enums.OrdStatus)value$; break;
    case 10: direction = (io.cygnuxltb.jcts.core.ser.enums.TrdDirection)value$; break;
    case 11: action = (io.cygnuxltb.jcts.core.ser.enums.TrdAction)value$; break;
   ...
   */
  public io.cygnuxltb.jcts.core.ser.enums.OrdStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public OrderEvent setStatus(io.cygnuxltb.jcts.core.ser.enums.OrdStatus value) {
    this.status = value;
    return this;
  }
   ...
   */
  public io.cygnuxltb.jcts.core.ser.enums.TrdDirection getDirection() {
    return direction;
  }
   ...
   * @param value the value to set.
   */
  public OrderEvent setDirection(io.cygnuxltb.jcts.core.ser.enums.TrdDirection value) {
   ...
   */
  public io.cygnuxltb.jcts.core.ser.enums.TrdAction getAction() {
    return action;
  }
   ...
   * @param value the value to set.
   */
  public OrderEvent setAction(io.cygnuxltb.jcts.core.ser.enums.TrdAction value) {
    this.action = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public OrderEvent setOfferPrice(long value) {
   ...
   * @param value the value to set.
   */
  public OrderEvent setTradePrice(long value) {
   ...
   */
  public static io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder();
  }
   ...
   * @return A new OrderEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderEvent RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder newBuilder(io.cygnuxltb.jcts.core.ser.event.OrderEvent other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.event.OrderEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMicros)) {
        this.epochMicros = data().deepCopy(fields()[0].schema(), other.epochMicros);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setEpochMicros(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearEpochMicros() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setTradingDay(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearTradingDay() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setInvestorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearInvestorId() {
      investorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setOrderRef(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearOrderRef() {
      orderRef = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setBrokerOrdSysId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearBrokerOrdSysId() {
      brokerOrdSysId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setStatus(io.cygnuxltb.jcts.core.ser.enums.OrdStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setDirection(io.cygnuxltb.jcts.core.ser.enums.TrdDirection value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearDirection() {
      direction = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setAction(io.cygnuxltb.jcts.core.ser.enums.TrdAction value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearAction() {
      action = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setOfferQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearOfferQty() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setFilledQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearFilledQty() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setOfferPrice(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearOfferPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setTradePrice(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearTradePrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setOfferTime(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearOfferTime() {
      offerTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setUpdateTime(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearUpdateTime() {
      updateTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder setMsg(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.event.OrderEvent.Builder clearMsg() {
      msg = null;
    ...
    public OrderEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[9] ? this.status : (io.cygnuxltb.jcts.core.ser.enums.OrdStatus) defaultValue(fields()[9]);
        record.direction = fieldSetFlags()[10] ? this.direction : (io.cygnuxltb.jcts.core.ser.enums.TrdDirection) defaultValue(fields()[10]);
        record.action = fieldSetFlags()[11] ? this.action : (io.cygnuxltb.jcts.core.ser.enums.TrdAction) defaultValue(fields()[11]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = io.cygnuxltb.jcts.core.ser.enums.OrdStatus.values()[in.readEnum()];

      this.direction = io.cygnuxltb.jcts.core.ser.enums.TrdDirection.values()[in.readEnum()];

      this.action = io.cygnuxltb.jcts.core.ser.enums.TrdAction.values()[in.readEnum()];
