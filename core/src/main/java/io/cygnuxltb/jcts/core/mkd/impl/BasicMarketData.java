...
public class BasicMarketData implements MarketData, JsonSerializable {
     ...
     */
    public static BasicMarketData newLevel5(@Nonnull Instrument instrument, long epochMillis) {
     ...
     * @return BasicMarketData
     */
    public static BasicMarketData newLevel5(@Nonnull Instrument instrument, @Nonnull LocalDateTime datetime) {
     ...
     * @return BasicMarketData
     */
    public static BasicMarketData newLevel5(@Nonnull Instrument instrument, @Nonnull LocalDate date,
