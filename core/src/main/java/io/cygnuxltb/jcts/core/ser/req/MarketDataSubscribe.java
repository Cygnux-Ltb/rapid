...
public class MarketDataSubscribe extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2949222397132023513L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MarketDataSubscribe\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.req\",\"doc\":\"行情订阅\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"MarketDataType\",\"namespace\":\"io.cygnuxltb.jcts.core.ser.enums\",\"doc\":\"行情类型\",\"symbols\":[\"DEPTH\",\"FAST\",\"LEVEL10\",\"LEVEL20\",\"LEVEL30\"]}},{\"name\":\"instrumentCodes\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}},{\"name\":\"recvAddr\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  ...
  private io.cygnuxltb.jcts.core.ser.enums.MarketDataType type;
   ...
   */
  public MarketDataSubscribe(io.cygnuxltb.jcts.core.ser.enums.MarketDataType type, java.util.List<java.lang.String> instrumentCodes, java.lang.String recvAddr) {
    this.type = type;
   ...
   */
  public io.cygnuxltb.jcts.core.ser.enums.MarketDataType getType() {
    return type;
  }
   ...
   */
  public MarketDataSubscribe setType(io.cygnuxltb.jcts.core.ser.enums.MarketDataType value) {
    this.type = value;
    return this;
  }
   ...
   */
  public static io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder newBuilder() {
    return new io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder();
  }
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder newBuilder(io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder(other);
    }
  }
   ...
   * @return A new MarketDataSubscribe RecordBuilder
   */
  public static io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder newBuilder(io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe other) {
    if (other == null) {
      return new io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder();
    } else {
      return new io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketDataSubscribe>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder setType(io.cygnuxltb.jcts.core.ser.enums.MarketDataType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder setInstrumentCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder clearInstrumentCodes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder setRecvAddr(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cygnuxltb.jcts.core.ser.req.MarketDataSubscribe.Builder clearRecvAddr() {
      recvAddr = null;
    ...
    public MarketDataSubscribe build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (io.cygnuxltb.jcts.core.ser.enums.MarketDataType) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.type = io.cygnuxltb.jcts.core.ser.enums.MarketDataType.values()[in.readEnum()];
