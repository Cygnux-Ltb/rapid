...
public class Account extends AvailableInstance implements Comparable<Account> {
     ...
     */
    public Account(AccountID accountId, @Nonnull String brokerCode, @Nonnull String investorCode) {
...
//                + "}";
    ...
    public static void main(String[] args) {
        var account = new Account(AccountID.of(1), "ZSQH", "200500");
