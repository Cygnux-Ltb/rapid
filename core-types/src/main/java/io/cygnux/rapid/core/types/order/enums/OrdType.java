...
public enum OrdType {
     ...
     * Limited
     */
    LIMITED(OrdConst.TYPE_LIMITED),
    /**
     * Market
     */
    MARKET(OrdConst.TYPE_MARKET),

    /**
     * Limited_Stop, 在目前的市场价格达到指定的止损价格时, 被激活成为限价单的报单.
     */
    LIMITED_STOP(OrdConst.TYPE_LIMITED_STOP),
    /**
     * Market_Stop, 在目前的市场价格达到指定的止损价格时, 被激活成为市价单的报单.
     */
    MARKET_STOP(OrdConst.TYPE_MARKET_STOP),

    /**
     * Market_To_Limited, 按照市价报单的方式成交, 不能成交的部分保留在报单队列中, 变成限价单的报单.
     */
    MTL(OrdConst.TYPE_MTL),
    /**
     ...
     */
    FOK(OrdConst.TYPE_FOK),
    /**
     * Fill_And_Kill, 表示要求立即成交, 对于无法满足的部分予以取消的报单.
     */
    FAK(OrdConst.TYPE_FAK),
