...
//
//    private static void loadNativeLibrary() throws NativeLibraryException {
...
//        switch (type) {
//            case MARKET_DATA -> this.mdGateway = new CtpMdGateway(gatewayId, config, publisher);
//            case TRADE -> this.traderGateway = new CtpTraderGateway(gatewayId, config, publisher);
//            default -> {
