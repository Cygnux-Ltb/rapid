...
public class AccountInfoPanel extends JPanel implements INewTab, IAccountHandler {
    ...
    private static class MarginModel extends AbstractTableModel {
        ...
        public String getColumnName(int col) {
            return switch (col) {
                case 0 -> "Tag";
                case 1 -> "Account Value";
                case 2 -> "Securities Value";
                case 3 -> "Commodities Value";
                default -> null;
            };
        }
        ...
        public Object getValueAt(int rowIn, int col) {
            ...
            return switch (col) {
                case 0 -> row.m_tag;
                case 1 -> format(row.m_val, row.m_currency);
                case 2 -> format(row.m_secVal, row.m_currency);
                case 3 -> format(row.m_comVal, row.m_currency);
                default -> null;
            };
        }
    }
    ...
    static class MktValModel extends AbstractTableModel {
        ...
        public String getColumnName(int col) {
            return switch (col) {
                case 0 -> "Account";
                case 1 -> "Currency";
                default -> MarketValueTag.get(col - 2).toString();
            };
        }
        ...
        public Object getValueAt(int rowIn, int col) {
            ...
            return switch (col) {
                ...
                case 1 -> row.m_currency;
                default -> format(row.get(MarketValueTag.get(col - 2)), null);
            };
        }
    }
