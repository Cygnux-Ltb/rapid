 ...
 */
@Repository
public interface OrderDao extends JpaRepository<TblTOrder, Long> {
    ...
    List<TblTOrder> queryBy(@Param("strategyId") int strategyId,
     ...
     * @return OrderEntity
     */
    TblTOrder queryByOrdSysId(long ordSysId);
