...
@Component("backtestAdapter")
public class BacktestAdapter extends AbstractAdapter implements BacktestController {
     ...
     */
    BacktestAdapter(BacktestScheduler scheduler) {
